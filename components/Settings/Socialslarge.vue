...
<template>
  <div class="mt-2.5 max-w-fit">
    <a
      ...
      :href="links.facebook"
      target="_blank"
      class="text-colorHighLight hover:text-colorHoverHighLight dark:text-colorHighDark dark:hover:text-colorHoverHighLight inline-block mx-3"
    >
    ...
    >
      ...
      >
        <path
          d="M20.75 4H3.25C2.01 4 1 5.01 1 6.25v11.5C1 18.99 2.01 20 3.25 20h17.5c1.24 0 2.25-1.01 2.25-2.25V6.25C23 5.01 21.99 4 20.75 4zm-.19 2L12 11.58 3.44 6h17.12zM3 7.4l8.44 5.32c.36.23.81.23 1.16 0L21 7.4v10.35c0 .41-.34.75-.75.75H3.75a.75.75 0 01-.75-.75V7.4z"
        />
      </svg>
    </a>
    ...
    >
      ...
      >
        <path
          d="M19.615 3.184c-1.6-.184-8.03-.184-8.03-.184s-6.43 0-8.03.184C2.067 3.336 1.278 4.147 1.184 5.536c-.184 2.784-.184 6.964-.184 6.964s0 4.18.184 6.964c.094 1.39.883 2.2 2.371 2.352 1.6.184 8.03.184 8.03.184s6.43 0 8.03-.184c1.488-.152 2.277-.963 2.371-2.352.184-2.784.184-6.964.184-6.964s0-4.18-.184-6.964c-.094-1.39-.883-2.2-2.371-2.352zM9.75 15.526V8.474l6.436 3.526-6.436 3.526z"
        />
      </svg>
    </a>
    ...
    >
      ...
      <svg
        ...
        x="0px"
        y="0px"
        class="h-10 w-10 fill-colorHighLight hover:fill-colorHoverHighLight dark:fill-colorHighDark hover:fill-colorHoverHighDark"
        viewBox="0 0 875 875"
